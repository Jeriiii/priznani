...
class DatingRegistrationManFourthForm extends DatingRegistrationBaseManForm {
	...
	public function submitted($form) {
		...
		$values = $form->values;
		$this->presenter->redirect('Datingregistration:registerCouple', $values->age, $values->marital_state, $values->orientation, $values->tallness, $values->shape, $values->smoke, $values->drink, $values->graduation, "", "", $values->penis_length, $values->penis_width);
	}
