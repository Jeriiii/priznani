...
class ImageComments extends BaseComments {
	...
	public function __construct(LikeCommentDao $likeCommentDao, CommentImagesDao $commentImagesDao, $image) {
		parent::__construct($likeCommentDao, $commentImagesDao, $image);
	}
